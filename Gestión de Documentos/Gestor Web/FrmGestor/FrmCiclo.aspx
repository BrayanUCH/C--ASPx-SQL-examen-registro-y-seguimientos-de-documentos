<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmCiclo.aspx.cs" Inherits="Gestor_Web.FrmGestor.FrmCiclo" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table style="width:100%;">
                <caption>
                    <strong>GESTOR DEL CICLO</strong></caption>
                <tr>
                ...
                <tr>
                    <td class="auto-style11">
                        <asp:Label ID="Label4" runat="server" Text="Nombre del tramite"></asp:Label>
                    </td>
                    <td class="auto-style3">
                        <asp:DropDownList ID="cbxCiclo_TramiteId" runat="server" Height="16px" Width="148px">
                        </asp:DropDownList>
                    </td>
                    <td class="auto-style2">&nbsp;</td>
                    <td class="auto-style1">&nbsp;</td>
                ...
                <tr>
                    <td class="auto-style11">
                        <asp:Label ID="Label3" runat="server" Text="Nombre del departamento"></asp:Label>
                    </td>
                    <td class="auto-style3">
                        <asp:DropDownList ID="cbxCiclo_DepartamentoId" runat="server" Height="16px" Width="147px">
                        </asp:DropDownList>
                    </td>
                    <td class="auto-style2">&nbsp;</td>
                    <td class="auto-style1">&nbsp;</td>
                ...
                <tr>
                    <td class="auto-style11">
                        <asp:Label ID="Label1" runat="server" Text="Orden del ciclo"></asp:Label>
                    </td>
                    <td class="auto-style3">
                        <asp:TextBox ID="txtCiclo_orden" runat="server" Width="140px"></asp:TextBox>
                    </td>
                    <td class="auto-style2">&nbsp;</td>
                    <td class="auto-style1">&nbsp;</td>
                    <td>
                ...
                <tr>
                    ...
                    <td class="auto-style3">
                        <asp:DropDownList ID="ddlCiclo" runat="server" CssClass="auto-style10" Height="20px" Width="157px">
                        </asp:DropDownList>
                    </td>
                    <td class="auto-style2">
                        <asp:CheckBox ID="ckbCiclo" runat="server" Text="MOSTRAR INACTIVOS" />
                    </td>
                    <td class="auto-style1">&nbsp;</td>
                    <td>
        ...
        <asp:GridView ID="gvCiclo" runat="server">
        </asp:GridView>
    </form>
</body>
</html>
